...
describe('Hero', () => {
  ...
  it('renders the title', () => {
    ...
    const titleElements = screen.getAllByText('Distinguished Engineer — AI Systems & Infrastructure');
  ...
  it('renders the tagline', () => {
    render(<Hero onOpenChat={() => {}} />);
    expect(
      screen.getByText('I architect multi-agent AI systems and the platform primitives that make them reliable, observable, and fast.')
    ).toBeInTheDocument();
  });
