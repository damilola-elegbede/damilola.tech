...
const MOCK_ANALYSIS = {
  ...
  proposedChanges: [
    ...
    },
    {
      ...
      modified: 'Led GCP cloud transformation for 30+ systems, cutting deploy time 60%',
      reason: 'Shortened to ~70 chars, frontloaded action verb and quantified result',
      relevanceSignals: ['led', 'cloud'],
      impactPoints: 3,
      impactPerSignal: 2,
      impactBreakdown: { roleRelevance: 1, claritySkimmability: 1, businessImpact: 1, presentationQuality: 0 },
    },
    {
      ...
      impactPoints: 5,
      impactPerSignal: 2,
      impactBreakdown: { roleRelevance: 3, claritySkimmability: 0, businessImpact: 1, presentationQuality: 1 },
    },
  ],
  optimizedScore: {
    total: 84,
