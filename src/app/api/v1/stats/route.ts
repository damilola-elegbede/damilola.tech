...
export async function GET(req: Request) {
  ...
  try {
    ...
    // For audit byType breakdown, fetch recent events only
    ...
    console.error('[api/v1/stats] Error getting stats:', error);
    return Errors.internalError('Failed to get stats');
  }
}
