...
export const resumeData: ResumeData = {
  ...
  skillsAssessment: {
    expert: [
      ...
      "LLM Infrastructure (serving, caching, inference pipelines)",
      "Cloud Platform Engineering (GCP / Kubernetes)",
      "Distributed Systems Design at Scale",
      "Technical Strategy + Architectural Influence",
      "Staff+ Cross-Team Technical Leadership",
      "Production Reliability + Incident Command",
    ],
    proficient: [
      "Agent Identity + Fleet Coordination",
      "CI/CD + DevOps (GitHub Actions, Vercel, Cloud Run)",
      "TypeScript / Python / Node.js",
      "Platform Engineering + SRE Principles",
      "Security Hardening (CSP, OAuth, secrets management)",
      "Terraform / Infrastructure as Code",
      "BigQuery + Distributed Caching",
      "Org Transformation + High-Performance Team Development",
    ],
    familiar: [
      "GPU Cluster Scheduling + ML Training Pipelines",
      "React / Next.js (App Router)",
      "AWS (EC2, S3, Lambda patterns)",
